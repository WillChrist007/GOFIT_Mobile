...
public class HistoryInstrukturActivity extends AppCompatActivity {

    private static final String TAG = HistoryInstrukturActivity.class.getSimpleName();

    private static final String BASE_URL = "https://200710569.gofit.backend.given.website/api/";
    private static final String API_BOOKING_KELAS = "presensiInstruktur/";
    ...
    private void retrieveBookingKelas(JSONArray kelassArray) {
        String url = BASE_URL + API_BOOKING_KELAS + getInsturkturId();
    ...
    private void displayData(JSONObject historyKelasObj, String nama_kelas) throws JSONException {
        ...
        String waktu_kelas = historyKelasObj.getString("jam_kelas");
        String jam_mulai = historyKelasObj.getString("jam_mulai");
        String jam_selesai = historyKelasObj.getString("jam_selesai");
